...
local locnet = nn.Sequential()  --input:64x64*32
locnet:add(cudnn.SpatialConvolution(32,64,3,3,1,1,1,1))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2))  --32x32
locnet:add(cudnn.SpatialConvolution(64,128,3,3,1,1,1,1))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2))  --16x16
locnet:add(cudnn.SpatialConvolution(128,256,3,3,1,1,1,1))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2)) --8x8
locnet:add(cudnn.SpatialConvolution(256,20,3,3,1,1,1,1))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2)) --4x4
locnet:add(cudnn.SpatialConvolution(20,20,3,3)) -- 2x2
locnet:add(cudnn.ReLU(true))
